...
test_eqs=[25,22,49,10,28,44,11,36,33,47,17,32,35,8,7,41,48,42,37,52];

for ii=1:length(test_eqs)

Test_EQ_ID = test_eqs(ii);    
...
AUC_eq_comp(ii,1)=test_eqs(ii);
AUC_eq_comp(ii,2)=AUC_eq;
ii
